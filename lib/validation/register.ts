...
type RegistrationErrors = RegistrationInfo

module.exports = function validateRegisterInput(data: RegistrationInfo) {
  const newData = { ...data }
  ...
  newData.password2 = !isEmpty(data.password2) ? data.password2 : ''
